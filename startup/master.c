...
#define INIT_FILE "/startup/init_file"
...

{
    ...
    if( member((["/obj/light.c", "/obj/simul_efun.c", "/obj/spare_simul_efun.c", "/startup/master.c" ]), base_file))
        return 0;
...

{
    ...
    else 
    {
	    ...
	    if (write_file(castle, def_castle)) 
        {
	        ...
	        if (!write_file("/startup/init_file", castle[1..] + "\n"))

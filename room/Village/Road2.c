...
{
    dest_dir = ({ 
		"room/Village/Road1","west",
		"room/Village/Shore","east",
		"room/AdventurersGuild/adv_guild","south",
		"room/Village/Station", "down",
		"room/Shop/shop","north" });
...
void start_harry() 
{
    if(!harry) 
	{
		...
		harry = clone_object("obj/Monster/monster");
...
int down() 
{
    this_player()->move_player("down#room/Village/Station");
    return 1;

...
void heart_beat() 
{
    ...
    if (level == 2)
	    "room/Church/church"->elevator_arrives();

    if (level == 1)
	    "room/Church/wiz_hall"->elevator_arrives();
}
...
int go_east() 
{
    ...
    if (level == 2)
	    this_player()->move_player("east#room/Church/church");
    
    if (level == 1)
	    this_player()->move_player("east#room/Church/wiz_hall");

    if (level == 3)
	    this_player()->move_player("east#room/Church/attic");
